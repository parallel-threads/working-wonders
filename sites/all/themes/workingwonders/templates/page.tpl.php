...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="drawer"><div class="section clearfix">
      <?php print $drawer_content; ?>
      <?php print $drawer_bottom; ?>
    </div></div> <!-- /.section, /#drawer -->

    <div id="top_navigation"><div class='section'><?php print $top_navigation; ?></div></div>
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <div id="content_top_columns">

          <div id="content_top_left"><div class="section">
            <?php print $content_top_left; ?>
          </div></div><!-- /.section, /#content_top_left -->

          <div id="content_top_right"><div class="section">
            <?php print $content_top_right; ?>
          </div></div><!-- /.section, /#content_top_right -->
