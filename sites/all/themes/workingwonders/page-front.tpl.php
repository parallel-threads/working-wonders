...
<head>
  ...
  <!--[if IE 7]><link rel="stylesheet" type="text/css" href="/<?php print $directory; ?>/css/IE7styles.css" /><![endif]-->
</head>
...
<div id="nav" class="clearfix">
    ...
    <!-- ______________________ MAIN _______________________ -->
		...
		<?php if ($hp_top): ?>
          <div id="hp-top" class="region region-hp-top hp-top">
            <?php print $hp_top; ?>
          </div> <!-- /#hp-top -->
        <?php endif; ?>
...
<div id="contentwrapper">
		...
		<?php if ($hp_midl): ?>
          <div id="midL" class="region region-midL midL">
            <?php print $hp_midl; ?>
          </div> <!-- /#midL -->
        <?php endif; ?>

		<?php if ($hp_midr): ?>
          <div id="midR" class="region region-midR midR">
            <?php print $hp_midr; ?>
          </div> <!-- /#midL -->
        <?php endif; ?>
		</div> <!--closes mid -->
