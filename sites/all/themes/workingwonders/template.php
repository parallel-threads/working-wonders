...
function workingwonders_views_mini_pager__uc_products_search ($tags = array (), $limit = 10, $element = 0, $parameters = array (), $quantity = 5) {
  // The keys view parameter generated by the search views module does not appear to use clean urls. Retrieve from the GET variable directly.
  return workingwonders_create_mini_pager ($tags, $limit, $element, $parameters, $quantity,
    '<a href="' . url ('product_search_all', array ('query' => array ('keys' => $_GET ['keys']))) . '">All</a>');
}
